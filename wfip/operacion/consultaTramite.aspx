<%@ Page Title="" Language="C#" MasterPageFile="~/operacion/operacion.Master" AutoEventWireup="true" CodeBehind="consultaTramite.aspx.cs" Inherits="wfip.operacion.consultaTramite" %>
                ...
                <ContentTemplate>
                            ...
                            <tr>
                                ...
                                <td style="width:60%; vertical-align: top; font-size:14px; "; >
                                    ...
                                    <table style="width: 100%;">
                                        ...
                                        <tr>
                                            <td colspan="3" style="text-align:center"><span style="font-size: 14px; font-weight: bold; color: #007CC3">CAPTURA POR EXCEL </span><hr /></td>
                                        </tr>
                                        <tr>
                                    ...
                                    <ContentTemplate>
                                        <asp:Panel ID="Seleccion" runat="server" Visible="true" >
                                            <table style="width: 100%;">
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:Button ID="ReSeleccion" runat="server" Text="Registrar" CssClass="boton" ValidationGroup="Seleccion" OnClick="RegistrarSeleccion" Visible="true"/>
                                                ...
                                                <table border="0" style="width: 100%;">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <asp:TextBox ID="TextNumKwik" runat="server" MaxLength="22"  Width="220px" AutoPostBack="false"></asp:TextBox>
                    ...
                    <dx:ASPxPopupControl ID="pnlPopNoAplica" 
	                    ...
	                    <FooterTemplate>
		                    <div style="text-align:right;">
                                <br />
			                    <dx:ASPxButton ID="btnPausaTramite" runat="server" AutoPostBack="False" EnableTheming="True" Text="No aplica" Theme="Aqua">
				                    <ClientSideEvents Click="function(s, e) 
					                    { 
						                    fnNoAplica();
					                    }" />
