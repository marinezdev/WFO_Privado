...
{
    public partial class consultaTramite2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (urlCifrardo.Result)
            {
                ...
                wfiplib.mesa oMesa = (new wfiplib.admMesa()).carga(Convert.ToInt32(urlCifrardo.IdMesa));
                ...
                if (!IsPostBack)
                {
                    ...
                    int idMesa = Convert.ToInt32(urlCifrardo.IdMesa);
                    ...
                    if (!inicializaPantalla(idMesa, idTramite))
                    {
                        ...
                        Response.Redirect(EncripParametros("flujo=" + intIdFlujo + ",res=1", "esperaOperacion.aspx").URL, true);
            ...
            {
                Response.Redirect("ListaTramite.aspx", true);
            }
        ...
        private bool inicializaPantalla(int pIdMesa, int pIdTramiteXParametro)
        {
            if (Convert.ToBoolean(Session["TramiteAutomatico"]) == false)
            {
                Propiedades.UrlCifrardo urlCifrardo = ConsultaParametros();
                //int intIdFlujo = Convert.ToInt32(Request.QueryString["flujo"]);
                Response.Redirect(EncripParametros("flujo=" + urlCifrardo.Flujo + ",res=1", "esperaOperacion.aspx").URL, true);
            ...
            if (idTramite > 0)
            {
                ...
                if (idTipoTramite == wfiplib.E_TipoTramite.indPriEmisionGMM || idTipoTramite == wfiplib.E_TipoTramite.indPriEmisionConversiones)
                {
                    label83.Visible = false;
                    CheckOneShot.Visible = false;
                }
                else
                {
                    label83.Visible = true;
                    CheckOneShot.Visible = true;
                }
        ...
        private void formulariosMesas(String NombreMesa, String TipoTramite)
        {
            ...
            //if (NombreMesa == "REVISIÓN PLAD" && TipoTramite != "indPriEmisionConversiones")
            ...
            if (NombreMesa == "ADMISIÓN")
            {
                ...
                if (TipoTramite == "Conversiones")
                {
                    label63.Visible = false;
                    CheckHombreClave.Visible = false;
                    label83.Visible = false;
                    CheckOneShot.Visible = false;
                    Label82.Visible = false;
                    CheckBoxExcel.Visible = false;
                    capturaExcel.Visible = false;
                }
            ...
            if (NombreMesa == "CITAS MÉDICAS")
            {
                ...
                btnGenerarCartaPrevia.Visible = true;
            }
        ...
        private void llenaFormularios(int pIdTramite)
        {
            ...
            switch (oTramite.IdTipoTramite)
            {
                ...
                case wfiplib.E_TipoTramite.indPriEmisionVidaCM:
                    ...
                    MuetraPLAD(pIdTramite, oEmisionGmm, oTramite.IdTipoTramite);
                ...
                case wfiplib.E_TipoTramite.indPriEmisionGMM:
                    ...
                    MuetraPLAD(pIdTramite, oEmisionVida, oTramite.IdTipoTramite);
                    SelccionDatosVida.Visible = false;
                ...
                case wfiplib.E_TipoTramite.indPriEmisionConversiones:
                    ...
                    MuetraPLAD(pIdTramite, oEmisionConversiones, oTramite.IdTipoTramite);
                    SelccionDatosVida.Visible = false;
                    MuestraSleccion(pIdTramite, oEmisionConversiones);
                    CargarInformacionTramite(pIdTramite, oEmisionConversiones, oTramite.IdTipoTramite);
                    cboMoneda.SelectedValue = "1";
                    cboMoneda.Enabled = false;
                    break;
            ...
            {
                // 2024/05/21   --- se deshabilito con el objetivo de que la mesa de calidad en el flujo de conversiones no muestre la daveertenia de reconsideracion por promotoria ya que en las pruebas relizar en GMM y VIDA nunca se habilita
...
#pragma warning restore CS0219 // La variable 'blnDeleteRow' está asignada pero su valor nunca se usa
        ...
        private void llenaDatosYBitacora(int pIdTramite, wfiplib.mesa oMesa)
        {
            ...
            switch (oTramite.IdTipoTramite)
            {
                ...
                case wfiplib.E_TipoTramite.indPriEmisionConversiones:
                    ltInfTipoTramite.Text = oTramite.Flujo.ToUpper() + "<br />";
                    ltInfTipoTramite.Text += "Conversiones (title)";
                    wfiplib.EmisionVG oEmisionConversiones = (new wfiplib.admEmisionVG()).cargaCompleto(pIdTramite);
                ...
                || oTramite.IdTipoTramite == wfiplib.E_TipoTramite.indPriEmisionConversiones)
            {
                ...
                if (oMesa.Nombre.ToUpper() == "CALIDAD")
                {
                    btnNoAplica.Text = "Aceptar";
                }
                ...
                {
                    //tdRechazar.Visible = true;    // 2024/05/21   --- se deshabilito con el objetivo de que la mesa de calidad en el flujo de conversiones no muestre el boton de rechazo ya que en las pruebas relizar en GMM y VIDA nunca se habilita
                    tdAceptar.Visible = false;
                }
        ...
        private void MuestraSleccion(int idTramite, wfiplib.EmisionVG oEmisionVG)
        {
            ...
            */
            ...
            if (lstRiesgos.Rows.Count > 0)
            {
                ...
                DataTable TBID = (new wfiplib.admSeleccion()).RamosGmmID(row["Ramo"].ToString(), oEmisionVG.TipoTramite.ToString());
                DataRow rowid = TBID.Rows[0];
        ...
        private bool AceptarKWIK()
        {
            ...
            wfiplib.mesa oMesa = (new wfiplib.admMesa()).carga(idMesa);
            if (oMesa.Nombre == "KWIK")
            {
                if (txComentariosPrv.Text.Trim() == TextNumKwik.Text.Trim())
                {
                    if (TextNumKwik.Text.Trim().Length != 26 ||
                            TextNumKwik.Text.Trim().Substring(0, 5) != "DCN [" ||
                            TextNumKwik.Text.Trim().Substring(TextNumKwik.Text.Trim().Length - 1, 1) != "]"
                        )
                    {
                        respuesta = false;
                    }
        ...
        protected void RegistrarSeleccion(object sender, EventArgs e)
        {
            ...
            if (TexFactor.Text.Trim() == "")
            {
                if (CatalogoFactores.SelectedItem.Text == "N/A" && TexFactor.Text.Trim() == "")
                {
                    validacion = true;
                }
            }
            ...
            {
                if (double.Parse(TexFactor.Text.Trim()) == 0)
                {
                    showMessage("No puede establecer un valor de cero (0) en el campo de FACTOR! \n\r Validar Datos requeridos sean completados");
                }
                else
                {
                    validacion = true;
            ...
            if (RamoSelecion.SelectedValue.Trim() == "-1") validacionCampos = false;
            if (TextID.Text.Trim().Length == 0) validacionCampos = false;
            if (FechaVigencia.Text.Trim().Length == 0) validacionCampos = false;
            if (CatParentesco.SelectedItem.Text.Trim() == "-1") validacionCampos = false;
            if (EndososGM.SelectedItem.Text.Trim() == "-1") validacionCampos = false;
            if (TextBoxOcupacionGM.Text.Trim().Length == 0) validacionCampos = false;

            if (!validacionCampos)
            {
                showMessage("favor de validar la que se capture toda la inforamcion requerida.");
                validacion = false;
            }
        ...
        private void MuetraPLAD(int idTramite, wfiplib.EmisionVG oEmisionVG, wfiplib.E_TipoTramite tipoTramite)
        {
            /***********************************************************/
            /*********************** Datos PLAD ************************/
            /***********************************************************/
            ...
            {
                if (tipoTramite != E_TipoTramite.indPriEmisionConversiones)
                {
        ...
        private void LimpiarInformacionTramite()
        {
            try
            {
                ...
                CheckOneShot.Checked = false; //01/07/21 JLVR
                CheckMetalifeEspecial.Checked = false; //01/07/21 JLVR
                InfoHobreClave.Text = "";
                InfoOneShotTexto.Text = "";
                InfoOneShotValue.Text = "";
                InfoMetaLifeTexto.Text = "";
                InfoMetaLifeValue.Text = "";
                dtFechaSolicitud.Text = "";
        ...
        private void CargarInformacionTramite(int pIdTramite, wfiplib.EmisionVG oEmisionGmm, E_TipoTramite idTipoTramite)
        {
            ...
            int tramitePrioridad = (int)oEmisionGmm.Prioridad;
            hdPrioridadTramite.Value = tramitePrioridad.ToString();
            ...
            if (texClave.Text == "770")
            {
                label84.Visible = true;
                CheckMetalifeEspecial.Visible = true;
                CheckMetalifeEspecial.Checked = oEmisionGmm.MetaLifeEspecial;
            }
            else
            {
                label84.Visible = false;
                CheckMetalifeEspecial.Visible = false;
                CheckMetalifeEspecial.Checked = false;
            }
            ...
            switch (idTipoTramite)
            {
                ...
                case wfiplib.E_TipoTramite.indPriEmisionVidaCM:
                    ...
                    if (GrandesSumas())
                    {
                        ...
                        GrandeSumas.Visible = true;
                        InfoGrandeSumas.Visible = true;
                    }
                    else if (GrandesSumasPrimaTotal())
                    {
                        PrimaTotalGrandeSumas.Text = "GRANDES SUMAS PRIMAS";
                        InfoGrandeSumas.Text = "GRANDES SUMAS PRIMAS";

                        PrimaTotalGrandeSumas.Visible = true;
                        InfoGrandeSumas.Visible = true;
                    }
            ...
            {
                if (oEmisionGmm.OneShot)
                {
                    CheckOneShot.Checked = true;
                    InfoOneShotTexto.Text = "ONESHOT";
                    InfoOneShotValue.Text = "SI";
                }
                else
                {
                    CheckOneShot.Checked = false;
                    InfoOneShotTexto.Text = "ONESHOT";
                    InfoOneShotValue.Text = "NO";
                }

                if (oEmisionGmm.MetaLifeEspecial)
                {
                    CheckOneShot.Checked = true;
                    InfoMetaLifeTexto.Text = "MetaLife Especial";
                    InfoMetaLifeValue.Text = "SI";
                }
                else
                {
                    CheckOneShot.Checked = false;
                    InfoMetaLifeTexto.Text = "MetaLife Especial";
                    InfoMetaLifeValue.Text = "NO";
                }
            }
            else
            {
                CheckOneShot.Checked = false;
                InfoOneShotTexto.Text = "";
                InfoOneShotTexto.Visible = false;
                InfoOneShotValue.Text = "";
                InfoOneShotValue.Visible = false;
            }
        ...
        private wfiplib.EmisionVG recuperaCaptura()
        {
            ...
            try
            {
                ...
                resultado.Prioridad = (wfiplib.E_PrioridadTramite)int.Parse(hdPrioridadTramite.Value);

                //si resultado.Prioridad = supervisor, se mantiene la prioridad de lo contrario se resetea la prioridad a normal y se valida las sumas aseguradas
                if (resultado.Prioridad != wfiplib.E_PrioridadTramite.Supervisor)
                {
                    resultado.Prioridad = wfiplib.E_PrioridadTramite.Tramite;

                    if (CheckMetalifeEspecial.Checked)
                    {
                        resultado.MetaLifeEspecial = true;
                        resultado.Prioridad = wfiplib.E_PrioridadTramite.MetalifeEspecial;
                    }
                    ...
                    // aquí va la validación de las prioridas
                    if (GrandesSumas())
                    {
        ...
        {
            bool _error = false;
            string numeroDCN = TextNumKwik.Text.Trim();

            if (numeroDCN.Length != 26 ||
                numeroDCN.Substring(0,5) != "DCN [" ||
                numeroDCN.Substring(numeroDCN.Length-1, 1) != "]"
            )
            {
                _error = true;
            }
            ...
            if (_error)
            {
                showMessage("el número de DCN es inválido");
            }
            else
            {
                wfiplib.admTramite oAdmTramite = new wfiplib.admTramite();
        ...
        protected void BtnContinuarAdmision_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (ValidantinuidadRFC())
                {
                    ...
                    if (GrandesSumas())
                    {
                        oDatos.Prioridad = wfiplib.E_PrioridadTramite.GrandesSumas;
                    }
                    else if (GrandesSumasPrimaTotal())
                    {
                        oDatos.Prioridad = wfiplib.E_PrioridadTramite.GrandesSumasPrimas;
                    }
                    else if (oDatos.HombreClave)
                    {
                        oDatos.Prioridad = wfiplib.E_PrioridadTramite.HombreClave;
                    }
                    else if (oDatos.MetaLifeEspecial)
                    {
                        oDatos.Prioridad = wfiplib.E_PrioridadTramite.MetalifeEspecial;
                    }
                    else
                    {
                        oDatos.Prioridad = E_PrioridadTramite.Tramite;
                    }



                    
                    // Almacenamos los datos antes de captura...
                    if (oAdmTramite.GuardaCapturaAntesDeCambio(oDatos.IdTramite))
                    {
                        if (oAdmTramite.ActualiaOrdenFecha(oDatos))
                        {
                            if (oAdmEmisionVG.AlteraTRAM00003P(oDatos))
...
#pragma warning restore CS0168 // La variable 'Fecha3' se ha declarado pero nunca se usa
        ...
        {
            PrimaTotalGrandeSumas.Visible = false;
...
#pragma warning restore CS0168 // La variable 'ex' se ha declarado pero nunca se usa
        ...
        {
            ScriptManager.RegisterStartupScript(this.mensajesInformativos, typeof(string), "Alert", "alert('" + Mensaje + "');   isSubmitted = false;", true);
        ...
        private wfiplib.tramiteMesa recuperaDatos()
        {
            ...
            wfiplib.tramiteMesa resultado = (new wfiplib.admTramiteMesa()).carga(Convert.ToInt32(hdIdTramite.Value), Convert.ToInt32(urlCifrardo.IdMesa));

            //NUEVO REQUERIMIENTO
            if (resultado.MesaNombre == "CALIDAD")
            {
                resultado.ObservacionPublica = txtObservacionNoAplica.Text.Trim();
            }
            else
            {
                resultado.ObservacionPublica = txComentarios.Text.Trim();
            }

            resultado.ObservacionPrivada = txComentariosPrv.Text.Trim();
            return resultado;
        }
        ...
        private string registraDocExp(int pIdTramite, string directorioTemporal)
        {
            ...
            try
            {
                ...
                string DirectoriSeparador = Server.MapPath("~") + expediente.CarpetaInicial;
                ...
                string nombreFusion = DirectoriSeparador + nombreArchivo + ".pdf";
            ...
            if (data.Rows.Count > 0)
            {
                if (txComentariosPrv.Text.Length > 0)
                {
                    ...
                    if (oAdmTramiteMesa.cambiaEstado(oTramiteMesa.IdTramite, oTramiteMesa.IdMesa, wfiplib.E_EstadoMesa.CMEnEsperaResult, oTramiteMesa.ObservacionPublica, oTramiteMesa.ObservacionPrivada))
                    {
                        ...
                        Propiedades.UrlCifrardo urlCifrardo = ConsultaParametros();
                        int idMesaRequeste = Convert.ToInt32(urlCifrardo.IdMesa);
        ...
        protected void ProcesarTramite(wfiplib.E_EstadoTramite statusTramite, wfiplib.E_EstadoMesa statusMesa, string motivosRechazos)
        {
            try
            {
                wfiplib.admTramiteMesa oAdmTramiteMesa = new wfiplib.admTramiteMesa();
                ...
                Application.Operacion.TramitesProcesar _operacionSP = new Application.Operacion.TramitesProcesar();
                System.Data.DataSet _resultado = _operacionSP.ProcesarTramite(oTramiteMesa, statusTramite, statusMesa, motivosRechazos);

                if (_resultado.Tables[0].Rows[0]["Tramite Procesado"].ToString() == "1" && _resultado.Tables[0].Rows[0]["IdTramite"].ToString() == oTramiteMesa.IdTramite.ToString())
                {
                    switch (int.Parse(_resultado.Tables[0].Rows[0]["Tramite Status"].ToString()))
                    {
                        case (int)wfiplib.E_EstadoTramite.Proceso:
                            break;

                        case (int)wfiplib.E_EstadoTramite.Rechazo:
                            GeneraCartaEstatusTramite(oTramiteMesa.IdTramite, wfiplib.E_EstadoTramite.Rechazo);
                            break;

                        case (int)wfiplib.E_EstadoTramite.Suspendido:
                            GeneraCartaEstatusTramite(oTramiteMesa.IdTramite, wfiplib.E_EstadoTramite.Suspendido);
                            break;

                        case (int)wfiplib.E_EstadoTramite.Hold:
                            GeneraCartaEstatusTramite(oTramiteMesa.IdTramite, wfiplib.E_EstadoTramite.Hold);
                            break;

                        default:
                            mensajes.MostrarMensaje(this, "Trámite no procesado correctamente...");
                            break;

                    }

                    // Obtenemos siguiente trámite
                    validaEnLinea();
                }
                else
                {
                    mensajes.MostrarMensaje(this, _resultado.Tables[0].Rows[0]["Desc"].ToString());
                }
            }
            catch (Exception ex)
            {
                // TODO: ### Pendiente: Registrar LOG de Error
                // mensajes.MostrarMensaje(this, "Ocurrio un error... Por favor contacte a soporte.");
                Console.WriteLine(ex.Message);
            }
            ...
            if (AceptarSeleccion())
            {
                if (AceptarEjecucion())
                {
                    ...
                    if (AceptarKWIK())
                    {
                        wfiplib.admTramite oAdmTramite = new wfiplib.admTramite();
                        wfiplib.EmisionVG oDatos = recuperaCaptura();
                        oAdmTramite.AlteraKwik(oDatos);
                        ProcesarTramite(wfiplib.E_EstadoTramite.Proceso, wfiplib.E_EstadoMesa.Procesado, "");
                    }
                    else
                    {
                        showMessage("El número de DCN no es correcto. Por favor verifiquelo!");
                    }
                }
                else
                {
                    showMessage("No se ha establecido un número de póliza correcto.");
                }
            }
            else
            {
        ...
        protected void btnSendToMesa_Click(object sender, EventArgs e)
        {
            try
            {
                string sendToMesa = string.Empty;
                for (int i = 0; i <= (lsOpSendToMesa.Items.Count - 1); i++)
                {
                    if (lsOpSendToMesa.Items[i].Selected)
                    {
                        if (sendToMesa.Length > 0)
                        {
                            sendToMesa += ",";
                        }
                        sendToMesa += lsOpSendToMesa.Items[i].Value.ToString();
                        break;
                    }
                }
                ...
                if (sendToMesa.Length > 0)
                {
                    ProcesarTramite(wfiplib.E_EstadoTramite.Proceso, wfiplib.E_EstadoMesa.SendToMesa, sendToMesa);
                }
                else
                {
                    mensajes.MostrarMensaje(this, "Debe seleccionar una mesa para realizar el envío.");
                }
        ...
        private void validaEnLinea()
        {
            ...
            if (hdEnLinea.Value.Equals("1"))
            {
                ...
                {
                    Session["tramiteActual"] = null;
                    if (urlCifrardo.Flujo == "")
                    {
                        Response.Redirect(EncripParametros("res=1", "esperaOperacion.aspx").URL, true);
                ...
                else /////  NUVA CONTINUIDAD 
                {
                    if (Convert.ToInt32(hdIdTramite.Value) > 0)
                    {
                        ...
                        Response.Redirect(EncripParametros("flujo=" + idTipoTramite + ",tp=" + hdIdMesa.Value.ToString(), "consultaTramite2.aspx").URL, true);
                        //Response.Redirect("consultaTramite2.aspx?flujo=" + idTipoTramite + "&tp=" + hdIdMesa.Value.ToString(), true);
                    }
                    else
                    {
                        Session["tramiteActual"] = null;
                        Response.Redirect(EncripParametros("flujo=" + urlCifrardo.Flujo, "esperaOperacion.aspx").URL, true);
        ...
        protected void lnkModificar_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect(EncripParametros("tp=" + idMesa + ",Id="+ hdIdTramite.Value, "anexoDocumento.aspx").URL, true);
        ...
        private void MuestraPDFAdicional(int pIdTramite, Literal pLtDocumentoPintar)
        {
            ...
            try
            {
                ...
                pLtDocumentoPintar.Text = "<iframe src='" + EncripParametros("IdTramite=" + pIdTramite, "../promotoria/Displaypdf.aspx").URL + "' style='width:100%; height:540px' style='border: none;'></iframe>";
        ...
        protected void rptInsumos_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                try
                {
                    ...
                    string archDestino = oInsumo.CarpetaArchivada + oInsumo.NmArchivo;
                    if (File.Exists(archDestino))
                    {
                        //    File.Copy(archOrigen, archDestino);
                        ImageButton btnExp = (ImageButton)(e.Item.FindControl("ImgExp"));
                        string strLinkDownload = oInsumo.CarpetaArchivada + oInsumo.NmArchivo;
                    ...
                    //string archDestino = Server.MapPath("~") + "DocsInsumos\\" + oInsumo.NmArchivo;
                    //if (File.Exists(archDestino))
                    //{
                    //    //    File.Copy(archOrigen, archDestino);
                    //    ImageButton btnExp = (ImageButton)(e.Item.FindControl("ImgExp"));
                    //    string strLinkDownload = "../DocsInsumos/" + oInsumo.NmArchivo;
                    //    // btnExp.OnClientClick = "Descarga('" + strLinkDownload + "'); return false;";
                    //    //btnExp.OnClientClick = "Descarga('" + oInsumo.NmArchivo + "'); return false;";
        ...
        protected void btnCtrlAplicaHold_Click(object sender, EventArgs e)
        {
            ...
            if (nodos.Count > 0)
            {
                ...
                ProcesarTramite(wfiplib.E_EstadoTramite.Hold, wfiplib.E_EstadoMesa.Hold, motivosRechazos);
        ...
        protected void btnCtrlAplicaSuspenderDir_Click(object sender, EventArgs e)
        {
            ...
            if (nodos.Count > 0)
            {
                ...
                {
                    txComentarios.Text = txtObservacionesSuspencion.Text.ToString();
                ...
                ProcesarTramite(wfiplib.E_EstadoTramite.Suspendido, wfiplib.E_EstadoMesa.Suspendido, motivosRechazos);
...
#pragma warning restore CS0219 // La variable 'x' está asignada pero su valor nunca se usa
        ...
        {
            int IdTramite = int.Parse(hdIdTramite.Value.ToString());
            string url = EncripParametros("IdTramite=" + IdTramite, "../promotoria/Displaypdf.aspx").URL;
            Response.Write("<script> window.open('" + url.ToString().Replace("\\", "/") + "','_blank', 'width = 600, height = 400'); </script>");

            //Response.Write("<script>window.open(''" + EncripParametros("IdTramite=" + IdTramite, "../promotoria/Displaypdf.aspx").URL + "''_blank', 'width = 600, height = 400');</script>");
        ...
        protected void btnMostrarCartarPrevia_clic(object sender, EventArgs e)
        {
            //Propiedades.UrlCifrardo urlCifrardo = ConsultaParametros();
            //int tramiteId = int.Parse(hdIdTramite.Value.ToString());
            //string Encrypt = (new Application.Operacion.UrlCifrardo()).Encrypt("Id=" + tramiteId.ToString());
            ...
            // http://localhost:52392/operacion/consultaTramite2.aspx?data=NISbMnAV2cnaf+tQmJ+rxMSrFiVztwnsLcKUrpjrZEs=


            int IdTramite = int.Parse(hdIdTramite.Value.ToString());
            string urldata = EncripParametros("Id=" + IdTramite, "../promotoria/CitaPDF.aspx").URL;
            //Response.Write("<script> window.open('" + url.ToString().Replace("\\", "/") + "','_blank', 'width = 600, height = 400'); </script>");
            string screenview = urldata;

            ScriptManager.RegisterStartupScript(this.mensajesInformativos, typeof(string), "Alert", "window.open('" + screenview + "', '_blank', 'PDF MetLife', 'width=400,height=500');", true);
