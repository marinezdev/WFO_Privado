<%@ Page Title="" Language="C#" MasterPageFile="~/operacion/operacion.Master" AutoEventWireup="true" CodeBehind="Buscar.aspx.cs" Inherits="wfip.operacion.Buscar" %>
    ...
    <div style="width:100%">
        <div style="width: 90%; margin:auto;">
            <fieldset>
                ...
                <div id="dvCajaBuscar" style="width: 100%;">
                    <div id="cajaRptBuscar" style="width: 95%; margin: auto; font-size: 10px; font-family: Arial;">
                        <asp:Repeater ID="rptBuscar" runat="server" OnItemDataBound="rptBuscar_ItemDataBound" OnItemCommand="rptBuscar_ItemCommand">
                            <HeaderTemplate>
                                <table id="tblBuscar" style="width:100%" class="display">
                                    <thead>
