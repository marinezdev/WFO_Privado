<%@ Page Title="" Language="C#" MasterPageFile="~/operacion/operacion.Master" AutoEventWireup="true" CodeBehind="esperaSupervisor.aspx.cs" Inherits="wfip.operacion.esperaSupervisor" %>
                        ...
                        <tr>
                            <td style="width: 50%; vertical-align: top">
                                <div id="dvGrafUno" style="width: 550px; margin: auto;">
                                    <asp:Chart ID="grfGrupoUno" runat="server" Width="540px" Height="300px" BackColor="211, 223, 240" BackGradientStyle="TopBottom" BackSecondaryColor="White" BorderColor="#1A3B69" BorderlineDashStyle="Solid" BorderWidth="2px" BorderlineColor="Black">
                                        <ChartAreas>
                            ...
                            <td style="vertical-align: top">
                                <div id="dvTacometro" style="width: 550px; margin: auto; text-align:center;">
                                    <dx:ASPxGaugeControl ID="deMedidorEfectrividad" runat="server" Height="70px" Width="300px" BackColor="#F2F2F2" Value="75" LayoutInterval="6">
                                        <Gauges>
                                            <dx:LinearGauge Bounds="6, 6, 288, 58" Name="linearGauge11" Orientation="Horizontal">
                                                <scales>
                                    ...
                                    <dx:ASPxGaugeControl ID="ASPxGaugeControl2" runat="server" BackColor="#F2F2F2" Height="60px" Value="2" Width="60px">
                                        <Gauges>
