<%@ Page Title="" Language="C#" MasterPageFile="~/operacion/operacion.Master" AutoEventWireup="true" CodeBehind="opOperadores.aspx.cs" Inherits="wfip.operacion.opOperadores" %>
    ...
    <fieldset>
        ...
        <table id="tblDatosBusca" style="width:50%; margin:auto;">
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlUsuario" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlUsuario_SelectedIndexChanged" Width="100%"></asp:DropDownList>
                </td>
            </tr>
        </table>
                ...
                <asp:Repeater ID="rptTrmPausa" runat="server" OnItemCommand="rptTrmPausa_ItemCommand">
                    ...
                    <ItemTemplate>
                        <tr style="background-color: White; color: #333333">
                            ...
                            <td style="width: 80px"><%# Eval("IdTramite","{0:0000#}")%></td>
                            ...
                            <td style="width: 100px; text-align: center;"><%# Eval("Observacion")%></td>
                            <td style="width: 20px; text-align:center"><asp:ImageButton ID="imbtnQuitarPausa" runat="server" ImageUrl="~/img/foward.png" CommandName='<%# Eval("IdMesa")%>' CommandArgument='<%# Eval("IdTramite")%>' OnClientClick="return Continuar();" /></td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
                        </tbody>
        ...
        <asp:Panel ID="pnTrmProceso" runat="server">
