...
{
    public partial class generalPorFlujo : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e) { if (!IsPostBack) { llenaCboFlujos(); pintaDatos(); } }
        ...
        private void pintaDatos()
        {
            ...
            DataTable datos = (new wfiplib.admIndicadores()).IndicadoresGeneralesMesas(IdFlujo);
        ...
        private void llenaGraficaUno(DataTable pDatos)
        {
            if(pDatos.Rows.Count > 0)
            {
                ...
                serieTotales.ChartType = SeriesChartType.Bar;
                ...
                serieRoja.ChartType = SeriesChartType.Bar;
                serieRoja.IsValueShownAsLabel = true;
                ...
                serieNaranja.ChartType = SeriesChartType.Bar;
                serieNaranja.IsValueShownAsLabel = true;
