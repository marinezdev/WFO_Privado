<%@ Page Title="" Language="C#" MasterPageFile="~/supervision/supervision.Master" AutoEventWireup="true" CodeBehind="sprReporteTramiteSemana.aspx.cs" Inherits="wfip.supervision.sprReporteTramiteSemana" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_areaTrabajo" runat="server">
    ...
    <fieldset>
        <legend> TRÁMITES POR SEMANA </legend>
        <br /><br />
    <div>
        <table style ="width:50%">
                ...
                <td>
                    <label>Año: &nbsp;</label> 
                    <asp:DropDownList runat="server" ID="Annio">
