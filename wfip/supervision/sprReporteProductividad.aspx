<%@ Page Title="" Language="C#" MasterPageFile="~/supervision/supervision.Master" AutoEventWireup="true" CodeBehind="sprReporteProductividad.aspx.cs" Inherits="wfip.supervision.sprReporteProductividad" %>
                ...
                <ContentTemplate>
                 <div id="dvCajaGrilla">
                     <dx:ASPxGridView ID="dvgdProductividad" ClientInstanceName="dvgdProductividad" runat="server" AutoGenerateColumns ="False" Width ="100%" 
                             style="margin-top: 0px" EnableTheming="True" Theme="iOS"  Font-Size ="10px"  KeyFieldName="mesaNombre">
                           <Columns>
                                <dx:GridViewDataTextColumn Caption= "OPERADOR" FieldName="operador" VisibleIndex="0" />
                                <dx:GridViewDataTextColumn Caption= "MESA" FieldName="mesaNombre" VisibleIndex="1" />
                                <dx:GridViewDataTextColumn Caption= "ACEPTADOS" FieldName="aceptado" VisibleIndex="2" />
                                <dx:GridViewDataTextColumn Caption= "RECHAZADOS" FieldName="rechazo" VisibleIndex="4" />
                                <dx:GridViewDataTextColumn Caption= "EN TRÁMITE" FieldName="tramite" VisibleIndex="5" />
                                <dx:GridViewDataTextColumn Caption= "EN PROCESO" FieldName="proceso" VisibleIndex="6" />
                                <dx:GridViewDataTextColumn Caption= "EN PAUSA" FieldName="pausa" VisibleIndex="7" />
                                <dx:GridViewDataTextColumn Caption= "SUSPENDIDOS" FieldName="suspendido" VisibleIndex="8" />

                                <dx:GridViewDataTextColumn Caption ="TOTAL TRÁMITES"  FieldName="totalTramites"  VisibleIndex="9" />
                                <dx:GridViewDataTextColumn Caption ="TIEMPO TOTAL"  FieldName="tiempo"  VisibleIndex="10" />
                               </Columns>
                               <Templates>
                                 <DetailRow>
