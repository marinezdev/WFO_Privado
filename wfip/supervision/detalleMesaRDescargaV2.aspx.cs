...
{
    public partial class detalleMesaRDescargaV2 : System.Web.UI.Page
    {
        ...
        protected void BtnDescargar_Click(object sender, EventArgs e)
        {
            ...
            {
                dt = (new wfiplib.NReportes()).SabanaReporteV2(CalDesde.Date, CalHasta.Date, manejo_sesion.Credencial.Id);
            }
