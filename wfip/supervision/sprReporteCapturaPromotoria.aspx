<%@ Page Title="" Language="C#" MasterPageFile="~/supervision/inicioSupervisor.Master" AutoEventWireup="true" CodeBehind="sprReporteCapturaPromotoria.aspx.cs" Inherits="wfip.supervision.sprReporteCapturaPromotoria" %>
                                            ...
                                            <table id="tblTramitesEspera" class="table table-striped table-bordered table-hover" style='width:100%'>
                                                <thead>
                                                    <tr >
                                                        ...
                                                        <th scope="col">Nombre Promotoria</th>
                                                        <th scope="col">Agente</th>
                                                        <th scope="col">Producto</th>
                                                        <th scope="col">Prioridad</th>
                                                        <!--th scope="col">xxxxxxxxxxxxxx</th-->
                                                        <!--th scope="col">xxxxxxxxxxxxxx</th-->
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td style="width: 20px; text-align:center">
                                                    <asp:ImageButton ID="imbtnConsultar" runat="server" ImageUrl="~/img/Folder.png" CommandName='Consultar' CommandArgument='<%# Eval("Id")%>' />
