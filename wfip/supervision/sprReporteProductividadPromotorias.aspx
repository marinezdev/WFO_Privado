<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sprReporteProductividadPromotorias.aspx.cs" Inherits="wfip.supervision.sprReporteProductividadPromotorias" MasterPageFile="~/supervision/supervision.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_areaTrabajo" runat="server">
    ...
    <fieldset>
        <legend> PRODUCTIVIDAD PROMOTORIAS </legend>
        <br /><br />
        <div>
            ...
            <table style="width:99%">
                <tr><td style="width:100%;vertical-align:top">
                    ...
                    <dx:ASPxGridView ID="dvgdEstatusTramite" ClientInstanceName="dvgdEstatusTramite" runat="server" 
                        ...
                        EnableTheming="false" 
                        Font-Size ="10px" 
                        Width="100%" SettingsDetail-ExportMode="All" SettingsExport-ExcelExportMode="Default" OnDataBinding="dvgdEstatusTramite_DataBinding">           
