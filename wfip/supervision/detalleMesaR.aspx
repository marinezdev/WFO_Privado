<%@ Page title="" Language="C#" MasterPageFile="~/supervision/inicioSupervisor.Master" AutoEventWireup="true" CodeBehind="detalleMesaR.aspx.cs" Inherits="wfip.supervision.detalleMesaR" %>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <asp:Button runat="server" ID="Button1"  class="btn btn-primary" text="Descargar Excel observaciones publicas" OnClientClick="Carga();" onclick="btnExportar_Click"/>
                <asp:Button runat="server" ID="DescargaExcel"  class="btn btn-primary" text="Descargar Excel observaciones privadas" OnClientClick="Carga();" onclick="btnExportar_Click2"/>
                <br /><br />
