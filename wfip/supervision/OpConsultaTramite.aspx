<%@ Page Title="" Language="C#" MasterPageFile="~/supervision/supervision.Master" AutoEventWireup="true" CodeBehind="OpConsultaTramite.aspx.cs" Inherits="wfip.supervision.OpConsultaTramite" %>
    ...
    <fieldset>
        <legend>INFORMACIÓN DEL TRÁMITE <asp:Label ID="Label2" runat="server"></asp:Label></legend>
            <div style="width: 90%; margin: auto">
                <asp:Button ID="btnRegresar"  CssClass="boton" runat="server" Visible="false" Text="Regresar" OnClick="btnRegresar_Clic" />
                <asp:Button ID="btnRegresarMapaMesa"  CssClass="boton" runat="server" Visible="false" Text="Regresar" OnClick="btnRegresarMapaMesa_Clic" />
                <br />
                                                            ...
                                                            <HeaderTemplate>
                                                                <table id="rptRiesgosTabla" style="width:100%; font-size:9px" class="display" >
                                                                    <thead>
                                                                        ...
                                                                        <th scope="col" style="background-color:#1572B7; color:white;">Riesgo</th>
                                                                        <th scope="col" style="background-color:#1572B7; color:white;">Riesgo factor</th>
                                                            ...
                                                            <HeaderTemplate>
                                                                <table id="rptRiesgosTablaVida" style="width:100%; font-size:9px" class="display" >
                                                                    <thead>
                                                                        ...
                                                                        <th scope="col" style="background-color:#1572B7; color:white;">No Captura</th>
                                                                        <th scope="col" style="background-color:#1572B7; color:white;">Vigencia</th>
                        ...
                        <td style="vertical-align: top" >
                            <table style="width: 100%;">
                                ...
                                <tr>
                                    <td>
                                        <br /><br />
                                        <asp:Button ID="btnGeneraCarta" CssClass="boton"  runat="server" Text="Mostrar Carta" AutoPostBack="true" Visible="false" CausesValidation="False" OnClick="btnGeneraCarta_Click">
                                        </asp:Button>
                                        <br />
                                        <asp:Label ID ="MsCitaMedica" runat="server" ForeColor="Crimson" Visible="false" ></asp:Label>
                                        <br />
                                        <asp:Button ID="btnGeneraCartaCitaMedica" CssClass="boton"  runat="server" Text="Mostrar Carta Cita Medica" AutoPostBack="true" Visible="false" CausesValidation="False" OnClick="btnGeneraCartaCitaMedica_Click">
                                        </asp:Button>
                                    </td>
                                </tr>
                            </table>
                ...
                <asp:Panel ID="pnTrmHistorial" runat="server" Width="100%">
                    <h4 style ="color:#187BB4">HISTORIAL TRÁMITE</h4>
                    <hr />
