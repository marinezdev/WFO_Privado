...
{
    public partial class sprReporteGrandesSumas : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                DataTable dt = (new wfiplib.admCatPrioridad()).ListaPrioridades();
                LisCat_Prioridad.DataSource = dt;
                LisCat_Prioridad.DataTextField = "Nombre";
                LisCat_Prioridad.DataValueField = "Id";
                LisCat_Prioridad.DataBind();
            }
        }
        ...
        protected void btnFiltroMes_Click(object sender, EventArgs e)
        {
            ...
            {
                int IdPrioridad = Convert.ToInt32(LisCat_Prioridad.SelectedValue);
                DataTable dt = (new wfiplib.admCatPrioridad()).TramitesPrioridad(CalDesde.Date, CalHasta.Date, IdPrioridad);
