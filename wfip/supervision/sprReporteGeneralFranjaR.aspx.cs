...
{
    public partial class sprReporteGeneralFranjaR : System.Web.UI.Page
    {
        ...
        #region Franja
        private void AcumuladoMensualFranja(DateTime Fecha)
        {
        ...
        private void MuestradatosFranja(DateTime Fecha)
        {
        ...
        private void LlenarDatosTS(int mes, int annio)
        {
        ...
        private void MuestradatosTendencia(DateTime Fecha)
        {
            DateTime fecha = DateTime.Now;
