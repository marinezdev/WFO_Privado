...
{
    public partial class sprTramitesFacturaKWIKV1 : System.Web.UI.Page
    {
        ...
        protected void btnFiltroMes_Click(object sender, EventArgs e)
        {
            ...
            {
                DataTable dt = (new wfiplib.admCatPrioridad()).TramitesFactuacionKWIK(CalDesde.Date, CalHasta.Date);
