<%@ Page Title="" Language="C#" MasterPageFile="~/supervision/inicioSupervisor.Master" AutoEventWireup="true" CodeBehind="sprTramitesFacturaKWIKV1.aspx.cs" Inherits="wfip.supervision.sprTramitesFacturaKWIKV1" %>
            ...
            <div class="container">
                <div class="col-md-12 col-sm-12 col-xs-12 text-left">
                    <div class="card">
                        ...
                        <h3><small>OneShot</small></h3>
                        </div>
                        <div class="card-body">
                            <p class="card-text">La consulta enlistará los trámites entre un rango de fechas a partir de la fecha de registro.</p>
                            <div class="row">
                                <div class="col-md-3 col-sm-3">
                                    <dx:aspxdateedit ID="CalDesde" runat="server" Theme="Material" EditFormat="Custom" DisplayFormatString="dd/MM/yyyy"   Width="190" Caption="Desde:">
                                ...
                                <div class="col-md-3 col-sm-3">
                                    <dx:aspxdateedit ID="CalHasta" runat="server" Theme="Material"  EditFormat="Custom" DisplayFormatString="dd/MM/yyyy" Width="190" Caption="Hasta">
                                        <TimeSectionProperties Adaptive="true">
                                            <TimeEditProperties EditFormatString="dd/MM/yyyy" />
                                        </TimeSectionProperties>
                                        <CalendarProperties>
                                    ...
                                    <asp:Repeater ID="rptTramitesEspera" runat="server" OnItemCommand="rptTramitesEspera_ItemCommand">
                                        <HeaderTemplate>
                                            <table id="tblTramitesEspera" class="table table-striped table-bordered table-hover" style='width:100%'>
                                                <thead>
                                                    <tr >
                                                        <th scope="col">Status Trámite</th>
                                                        <th scope="col">Folio</th>
                                                        <th scope="col">Registr trámite</th>
                                                        <th scope="col">Mesa</th>
                                                        <th scope="col">Status Mesa</th>
                                                        <th scope="col">Fecha Procesó en KWIK</th>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td><%# Eval("Status Trámite")%></td>                                               
                                                <td><%# Eval("Folio")%></td>                                               
                                                <td><%# Eval("Registr trámite")%></td>                                               
                                                <td><%# Eval("Mesa")%></td>                                               
                                                <td><%# Eval("Status Mesa")%></td>                                               
                                                <td><%# Eval("Fecha Procesó en KWIK")%></td>                                               
                                                <td><%# Eval("Póliza")%></td>                                               
                                                <td><%# Eval("DCN KWIK")%></td>                                               
                                                <td><%# Eval("Obs Pública")%></td>                                               
                                                <td><%# Eval("Obs Privada")%></td>                                               
                                            </tr>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                            </tbody>
