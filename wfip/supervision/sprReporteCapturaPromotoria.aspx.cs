...
{
    public partial class sprReporteCapturaPromotoria : System.Web.UI.Page
    {
        ...
        protected void btnFiltroMes_Click(object sender, EventArgs e)
        {
            ...
            {
                DataTable dt = (new wfiplib.admCatPrioridad()).CapturaPromotoriaAdm(CalDesde.Date, CalHasta.Date);
