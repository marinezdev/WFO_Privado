...
{
    public partial class sprReporteProductividad : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            string modulo = manejo_sesion.Credencial.Modulo.ToString();
            string rol = manejo_sesion.Credencial.IdRol.ToString();
            string grupo = manejo_sesion.Credencial.Grupo.ToString();
            if ((modulo == "Operacion" && grupo=="Operador") || rol=="3") cmbUsuarios.Visible = false;
        ...
        private void Muestradatos()
        {
            ...
            if ((modulo == "Operacion" && grupo=="Operador") ||rol=="3") usuarios= manejo_sesion.Credencial.Nombre.ToString();
            else usuarios =cmbUsuarios.Text;
