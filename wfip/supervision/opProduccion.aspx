<%@ Page Title="" Language="C#" MasterPageFile="~/supervision/supervision.Master" AutoEventWireup="true" CodeBehind="opProduccion.aspx.cs" Inherits="wfip.operacion.opProduccion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_areaTrabajo" runat="server">
    <fieldset>
        <legend>CONSULTA DE PRODUCTIVIDAD MENSUAL</legend>
        <table id="tblDatosBusca" style="width:100%; margin:auto;">
            <tr>
                <td style="text-align:right; width:20%">Usuario:</td>
                <td>
                    <asp:DropDownList ID="ddlUsuario" runat="server" Width="30%"></asp:DropDownList>
                </td>
            </tr>
            <tr>
