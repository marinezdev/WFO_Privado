...
{
    public partial class CartePDFCancelar : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (urlCifrardo.Result)
            {
                ...
                cartas.CartaCancelaPDF(Int32.Parse(urlCifrardo.IdTramite), Response, Int32.Parse(urlCifrardo.PDF), manejo_sesion.Credencial.Id);
            }
            ...
            //    }
            //    wfiplib.admCartas cartas = new wfiplib.admCartas();
            //    cartas.CartaCancelaPDF(Id, Response, CreaPDF, manejo_sesion.Credencial.Id);
            //}
        }
