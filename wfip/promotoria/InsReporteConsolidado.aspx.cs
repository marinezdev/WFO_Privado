...
namespace wfip.promotoria
{
    public partial class ReporteConsolidado : System.Web.UI.Page
    {
        ...
        wfiplib.admPolizasDetalleConsolidado pdc = new wfiplib.admPolizasDetalleConsolidado();
        ...
        protected void BtnGenerar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                wfiplib.LlenarControles.LlenarGridView(ref gvAgregado, pdc.Seleccionar());
                //gvAgregado.DataSource = pdc.Seleccionar();
                //gvAgregado.DataBind();
            ...
            catch (Exception es)
            {
                ...
                mensaje.MostrarMensaje(this, "Error al tratar de ejecutar el reporte: " + es.Message);
            }
        }
