<%@ Page Title="" Language="C#" MasterPageFile="~/promotoria/promotoria.Master" AutoEventWireup="true" CodeBehind="tramitesPorEstado.aspx.cs" Inherits="wfip.promotoria.tramitesPorEstado" %>
        ...
        <div style="width: 90%; margin:auto;">
            <fieldset>
                <div style="margin-left: auto; margin-right: auto; text-align: center;">
                   <asp:Label ID="Label3" runat="server" visible ="false" Text="El tramite solicitado se suspende, ya que por temas normativos no es posible contar con información financiera de los clientes" Font-Bold="true "
                    CssCla ="StrongText"></asp:Label>
                </div>
