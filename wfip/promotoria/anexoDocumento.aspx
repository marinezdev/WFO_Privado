<%@ Page Title="" Language="C#" MasterPageFile="~/promotoria/promotoria.Master" AutoEventWireup="true" CodeBehind="anexoDocumento.aspx.cs" Inherits="wfip.promotoria.anexoDocumento" %>
                ...
                <tr>
                    <td style="width:50%">
                        <fieldset>
                            ...
                            <asp:FileUpload ID="fileUpDocumento" runat="server" />
                             <%--<asp:RegularExpressionValidator ID="rev_fileUpDocumento" runat="server" ErrorMessage="Solo PDF" ControlToValidate="fileUpDocumento" ValidationExpression= "(.*).(.pdf|.PDF)$" />--%>
                            <asp:Button ID="btnSubirDocumento" runat="server" Text="Subir" CssClass="boton" OnClick="btnSubirDocumento_Click" /><span style="font-size: 9px">Tamaño máximo de archivo: <%= ArchivoMaximo1 %> 3mb</span><br />
                    ...
                    <td>
                        ...
                        <fieldset>
                            ...
                            <asp:Button ID="btnSubirInsumo" runat="server" Text="Subir" CssClass="boton" OnClick="btnSubirInsumo_Click" /><span style="font-size: 9px">Tamaño máximo de archivo: <%= ArchivoMaximo2 %> 3mb</span><br />
