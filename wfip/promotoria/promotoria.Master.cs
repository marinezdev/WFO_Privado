...
{
    public partial class promotoria : System.Web.UI.MasterPage
    {
            ...
            if (!IsPostBack)
            {
                if (Session["credencial"] != null)
                {
                    ...
                    if (System.Configuration.ConfigurationManager.AppSettings["MenuDinamico"].ToString() == "S")
                        lblMenu.Text = menu.CrearMenuHTML(manejo_sesion.Credencial.IdRol); // Menú Automático. 
                    else
                    {
                    ...
                    lbMstNombrePromotora.Text = manejo_sesion.Promotoria.Nombre;
                }
            }
        }
        /*
