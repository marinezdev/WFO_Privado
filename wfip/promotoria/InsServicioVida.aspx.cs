...
{
    public partial class InsServicioVida : System.Web.UI.Page
    {
        ...
        protected void cboTipoContratante_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (cboTipoContratante.SelectedValue.Equals("3"))
            {
                ReconAnt.Visible = true;
                Altas.Visible = false;
                Bajas.Visible = false;
                Cartas.Visible = false;
                Listado.Visible = false;
            }
            else if (cboTipoContratante.SelectedValue.Equals("4"))
            {
                Cartas.Visible = true;
                Altas.Visible = false;
                Bajas.Visible = false;
            ...
            else if (cboTipoContratante.SelectedValue.Equals("5"))
            {
