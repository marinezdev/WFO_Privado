...
{
    public partial class EmisionVida_Fisica : System.Web.UI.Page
    {
        ...
        private wfiplib.EmisionVida cargaDatos()
        {
            ...
            Resultado.FechaNacimiento = Convert.ToDateTime(txFechaNac.Text.Trim());
            Resultado.Edad=Convert.ToInt32( txEdad.Text.Trim());
            Resultado.RFC = txRfc.Text.Trim();
            Resultado.CURP= txCurp.Text.Trim();
            Resultado.Sexo =Convert.ToInt32(dpSexo.SelectedValue);
            Resultado.EstadoCivil =Convert.ToInt32(dpEstadoCivil.SelectedValue);
            Resultado.LugarNacimPais= txLnPais.Text.Trim();
            Resultado.LugarNacimEstado  =txLnEstado.Text.Trim();
            Resultado.LugarNacimCiudad=txLnCiudad.Text.Trim();
            Resultado.Nacionalidad=txLnNacionalidad.Text.Trim();
            ...
            Resultado.Telefono1=txTelParticular.Text.Trim();
            Resultado.Telefono2=txTelOficina.Text.Trim();
            Resultado.Extencion=txExtencion.Text.Trim();
            Resultado.Movil=txMovil.Text.Trim();
