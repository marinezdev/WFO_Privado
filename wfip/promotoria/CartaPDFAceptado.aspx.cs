...
{
    public partial class CartaPDFAceptado : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (urlCifrardo.Result)
            {
                ...
                cartas.CartaAceptadoPDF(Int32.Parse(urlCifrardo.IdTramite), Response, Int32.Parse(urlCifrardo.PDF), manejo_sesion.Credencial.Id);
            }
            ...
            //    wfiplib.admCartas cartas = new wfiplib.admCartas();
            //    cartas.CartaAceptadoPDF(Id, Response, CreaPDF, manejo_sesion.Credencial.Id);
