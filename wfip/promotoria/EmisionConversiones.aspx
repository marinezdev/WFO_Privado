<%@ Page Title="" Language="C#" MasterPageFile="~/promotoria/iniPromotoria.Master" AutoEventWireup="true" CodeBehind="EmisionConversiones.aspx.cs" Inherits="wfip.promotoria.EmisionConversiones" %>
            ...
            <div class="container">
                <div class="col-md-12 col-sm-12 col-xs-12 text-left">
                    <div class="card">
                        ...
                        <h3><small> INDIVIDUAL PRIVADO EMISIÓN - GASTOS MÉDICOS - NC </small></h3>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <asp:Panel ID="Tramite" runat="server" Visible="true">
                                        <asp:Panel ID="producto1" runat="server" Visible="true">
                                            <asp:Label ID="lblProductoRamo" runat="server" Text="* Producto" Font-Bold="true" class="control-label col-md-2 col-sm-2 col-xs-12"></asp:Label>
                                            <div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
                                                <asp:DropDownList ID="LisProducto1" runat="server" AutoPostBack="True" OnSelectedIndexChanged="LisProducto1_SelectedIndexChanged" class="form-control">
                                        ...
                                        <asp:Panel ID="subproducto1" runat="server" Visible="false">
                                            <asp:Label ID="lblSubProductoRamo" runat="server" Text="Plan" Font-Bold="true" class="control-label col-md-2 col-sm-2 col-xs-12"></asp:Label>
                                            <div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <asp:Label runat="server" ID="Moneda" Text="* Moneda" Font-Bold="True" class="control-label col-md-2 col-sm-2 col-xs-12 "></asp:Label>
                                    <div class="col-md-2 col-sm-2 col-xs-12 form-group has-feedback">
                                        <asp:DropDownList ID="cboMoneda" runat="server" AutoPostBack="True"  class="form-control" ></asp:DropDownList>
                                    ...
                                    <asp:Label runat="server" ID="SumaAsegurada" Text="* Suma Asegurada Básica" Font-Bold="True" class="control-label col-md-2 col-sm-2 col-xs-12 "></asp:Label>
                                    <div class="col-md-2 col-sm-2 col-xs-12 form-group has-feedback">
                                        <asp:TextBox ID="txtSumaAseguradaBasica"  onChange="MASK('cph_areaTrabajo_txtSumaAseguradaBasica','###,###,###,###,##0.00',1)" onfocus="if(this.value == '0.00') {this.value=''}" onblur="if(this.value == ''){this.value ='0.00'}" value="0.00" runat="server" MaxLength="15" AutoPostBack="true" class="form-control "></asp:TextBox>
                                    ...
                                    <asp:Panel ID="SumaAseguradaPolizasVigentes" runat="server" Visible="False">
                                        <asp:Label runat="server" ID="label9" Text="* Prima Total de Acuerdo a Cotización " Font-Bold="true" class="control-label col-md-2 col-sm-2 col-xs-12 "></asp:Label>
                                        <div class="col-md-2 col-sm-2 col-xs-12 form-group has-feedback">
                                            <asp:TextBox ID="txtPrimaTotal" OnTextChanged="PrimaTotalGrandesSumas" onChange="MASK('cph_areaTrabajo_txtPrimaTotal','###,###,###,###,##0.00',1)" onfocus="if(this.value == '0.00') {this.value=''}" onblur="if(this.value == ''){this.value ='0.00'}" value="0.00" runat="server" MaxLength="15" AutoPostBack="true" class="form-control "></asp:TextBox>
                                    ...
                                    <asp:Panel ID="SumaAseguradaPolizasVigentesGMM" runat="server" Visible="false">
                                        ...
                                        <div class="col-md-7 col-sm-7 col-xs-12 form-group has-feedback">
                                            <asp:TextBox ID="txtPrimaTotalGMM" onChange="MASK('cph_areaTrabajo_txtPrimaTotalGMM','###,###,###,###,##0.00',1)" onfocus="if(this.value == '0.00') {this.value=''}" onblur="if(this.value == ''){this.value ='0.00'}" value="0.00" runat="server" MaxLength="15" AutoPostBack="true" class="form-control "></asp:TextBox>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <asp:Panel ID="PanelTipoTramite" runat="server" Visible="true">
                                        <asp:Label ID="Label2" runat="server" Text="* Tipo de trámite" Font-Bold="true" class="control-label col-md-2 col-sm-2 col-xs-12"></asp:Label>
                                        <div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
                                            <asp:DropDownList ID="LisInstituciones" runat="server" AutoPostBack="True"  class="form-control">
                                                <asp:ListItem Value=" ">Seleccionar</asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="LisInstituciones" ErrorMessage="*" InitialValue="-1" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </div>
                                    </asp:Panel>
                                </div>
                            </div>
