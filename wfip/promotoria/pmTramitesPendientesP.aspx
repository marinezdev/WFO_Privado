<%@ Page Title="" Language="C#" MasterPageFile="~/promotoria/promotoria.Master" AutoEventWireup="true" CodeBehind="pmTramitesPendientesP.aspx.cs" Inherits="wfip.promotoria.pmTramitesPendientesP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_areaTrabajo" runat="server">
    ...
    <div style="width:100%">
        <div style="width: 90%; margin:auto;">
            <fieldset>
                <legend>TRAMITES PENDIENTES <asp:Label ID="Label2" runat="server"></asp:Label> </legend>
                <div id="dvCajaTramite" style="width: 100%;">
                        ...
                        <asp:Repeater ID="rptTramite" runat="server" OnItemDataBound="rptTramite_ItemDataBound" OnItemCommand="rptTramite_ItemCommand">
                            ...
                            <ItemTemplate>
                                <tr style="background-color: White; color: #333333">
                                    <td style="width: 100px;text-align: center;"><%# Eval("FechaRegistro","{0:dd/MM/yyyy HH:mm:ss}")%></td>
                    ...
                    <dx:ASPxGridView ID="dvgdListaTramites" ClientInstanceName="dvgdListaTramites" runat="server" AutoGenerateColumns ="False" Width ="100%" 
                           ...
                           <Columns>
                                ...
                                <dx:GridViewDataTextColumn Caption= "NUM TRÁMITE" FieldName="Id" VisibleIndex="1" />
                                <dx:GridViewDataTextColumn Caption= "ORDEN DE TRABAJO" FieldName="NumeroOrden" VisibleIndex="2" />
                                <dx:GridViewDataTextColumn Caption ="TIPO DE TRÁMITE"  FieldName="TramiteNombre"  VisibleIndex="3" />
