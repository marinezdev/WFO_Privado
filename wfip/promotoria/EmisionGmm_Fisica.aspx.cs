...
{
    public partial class EmisionGmm_Fisica : System.Web.UI.Page
    {
        ...
        private wfiplib.EmisionGmm cargaDatos()
        {
            ...
            Resultado.LugarNacimPais = txLnCiudad.Text.Trim();
            ...
            Resultado.Telefono1 = txTelefono.Text.Trim();
            Resultado.Correo = txCorreo.Text.Trim();
            Resultado.Idetificacion =Convert .ToInt32 (dpIdentificacion.SelectedValue);
            Resultado.NoIdentificacion = txNoIdentificacion.Text.Trim();
            return Resultado;
        }
