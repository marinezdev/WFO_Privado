<%@ Page Title="" Language="C#" MasterPageFile="~/administracion/adminsysMaster.Master" AutoEventWireup="true" CodeBehind="admPasos.aspx.cs" Inherits="wfip.administracion.admPasos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_areaTrabajo" runat="server">
    ...
    <div style ="width:80%; margin:0 auto">
        <fieldset>
            <legend>CATALOGO DE ETAPAS</legend>
                ...
                <table style ="width :100%;">
                    ...
                    <tr>
                        <td colspan ="2" style="text-align:left">
                            <asp:Label ID="lbIdEtapa" runat="server" Visible ="False" Font-Bold="True"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <ItemTemplate>
                        <tr style="background-color: White; color: #333333">
                            ...
                            <td style="width: 35px; text-align:center">
                                <asp:ImageButton ID="imgBtnActivo"  runat ="server"  ImageUrl="~/img/activo.png" CommandName="activo" CommandArgument='<%# Eval("Id")%>' CausesValidation="false" ToolTip ="Estado"/>
                            </td>
                            <td style="width: 35px; text-align:center">
