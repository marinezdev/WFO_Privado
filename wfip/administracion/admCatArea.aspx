<%@ Page Title="" Language="C#" MasterPageFile="~/administracion/adminsysMaster.Master" AutoEventWireup="true" CodeBehind="admCatArea.aspx.cs" Inherits="wfip.administracion.admCatArea" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_areaTrabajo" runat="server">
    ...
    <asp:HiddenField ID ="hdIdArea" runat ="server" />
    <div style ="width:80%; margin:0 auto">
        <fieldset>
            <legend>CATALOGO DE AREAS</legend>
            ...
            <div id="dvDatos" runat ="server">
                <table style ="width :80%; margin: 0 auto">
                    <tr>
                        <td style ="width:15%"><b>Nombre area:</b></td>
                    ...
                    <tr>
                        <td colspan="3" style="text-align:right;">
                            <asp:Button ID="btnModificar" runat="server" Text="Modificar" CssClass="boton" OnClientClick="return Confirmar();" OnClick="btnModificar_Click" Visible="False" />&nbsp;&nbsp;
                            <asp:Button ID="btnModCancela" runat="server" Text="Cancelar" CssClass="boton" OnClick="btnModCancela_Click" Visible="False" CausesValidation ="false" />&nbsp;&nbsp;
            ...
            <asp:Panel ID ="pnAreas" runat="server" Height ="350px" ScrollBars="Auto">
                <asp:Repeater ID="rptAreas" runat="server" OnItemCommand="rptAreas_ItemCommand" >
                    <HeaderTemplate>
                        <table id="tblAreas" style="width:100%" class="display" >
                            <thead>
