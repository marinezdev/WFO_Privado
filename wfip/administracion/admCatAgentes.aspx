<%@ Page Title="" Language="C#" MasterPageFile="~/administracion/adminsysMaster.Master" AutoEventWireup="true" CodeBehind="admCatAgentes.aspx.cs" Inherits="wfip.administracion.admCatAgentes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_areaTrabajo" runat="server">
    ...
    <asp:HiddenField ID ="hdIdAgente" runat ="server" />
    <div style ="width:80%; margin:0 auto">
        <fieldset>
            <legend>CATALOGO DE AGENTES</legend>
            ...
            <asp:Panel  ID="pnAgentes" runat="server" Height="350px"  ScrollBars ="Auto" >
                <asp:Repeater ID="rptAgentes" runat="server" OnItemCommand="rptAgentes_ItemCommand" >
                    <HeaderTemplate>
                        <table id="tblAgentes" style="width:100%" class="display" >
                            <thead>
                    ...
                    <ItemTemplate>
                        <tr style="background-color: White; color: #333333">
                            <td><%# Eval("Nombre")%></td>
                            <td style="width: 100px"><%# Eval("Rfc")%></td>
