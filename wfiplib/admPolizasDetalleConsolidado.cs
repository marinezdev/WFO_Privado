...
namespace wfiplib
{
    public class admPolizasDetalleConsolidado
    {
        ...
        public DataTable Seleccionar()
        {
            string consulta = "delete from PolizasDetalleConsolidado; " + 
                ...
                "	primaajustes int " +
                ") " +
                "UPDATE PolizasDetalle26 SET PrimaPotenciadaQR=NULL WHERE IsNull(PrimaPotenciadaQR, '')='' " +
                "UPDATE PolizasDetalle26 SET MontoAjustePrimaP=NULL WHERE IsNull(MontoAjustePrimaP, '')='' " +
